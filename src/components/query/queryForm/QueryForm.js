...
function QueryForm(props) {
  ...
  const isDisabled=()=>{
    ...
    if(formData["Name"].length>0 && formData["Mobile Number"].length>0 && formData["Company"].length>0 && formData["Email"].length>0 && formData["Your Message"].length>0){
      return false
    }else{
      return true
    }
  ...
  return (
    <div className="queryForm-section">
        ...
        <form ref={form} onSubmit={sendEmail}>
          <div className="query-input">
            ...
            <div className="query-footer-section">
              <div>
              {showError && <span className="error-message">Please enter a valid email</span>}
              </div>
             <div>
              <input
                type="submit"
